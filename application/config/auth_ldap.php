...
$config['use_ad'] = true;
$config['ad_domain'] = 'CTLINT';
$config['proxy_user'] = 'zz_ldap';
$config['proxy_pass'] = 'Q36buCA$';
$config['roles'] = array(1 => 'User', 
    3 => 'Power User',
    5 => 'Administrator');
$config['member_attribute'] = 'memberOf';
$config['whitelist']=array('cl-members','cl-employees','cl-international');
$config['user_whitelist']=array('user');
$config['admin_groups']=array('cl-employees', 'internal-subscriptions-edit.g');
$config['auditlog'] = '/var/log/subscriptions/audit.log';  // Some place to log attempted logins (separate from message log)
?>
